...
* Test Steps
  ...
  9. Click on part 2 , and select the language and then click on done button
...
* Expected result
  ...
  9. The result in both Input in IT3 format and Output in unicode UTF-8 should be displayed.
