...
* Objective
  - To view the References of the Manual speech signal-to-symbol transformation References
...
* Test Steps
  ...
  3. Click on the referred links present in the reference page

* Expected result
  1. References page should be opened
  2. Content should be present with no distortions and Junk characters
  3. A new tab should be opened with the reffered link.
