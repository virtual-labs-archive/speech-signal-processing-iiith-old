...
<table width=900><tr>
<td><h2>Part-3: Segmentation without feedback </h2></td>
...
echo "<font size=-1><ol><li>Choose your language and construct a sentence using the IT3 transliteration format given below.</li>";
echo "<li>Verify the corresponding text in the native script of the language.</li></ol></font>";
include('trans.html');
}
?>
</html>
