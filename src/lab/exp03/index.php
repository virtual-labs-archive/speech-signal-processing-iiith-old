...
$css_js   = "http://deploy.virtual-labs.ac.in/labs/cse16/"; 
$lab_url  = "http://deploy.virtual-labs.ac.in/labs/cse16/index.php";
$exp_url  =  "http://deploy.virtual-labs.ac.in/labs/cse16/exp03/index.php";
$base_url = $exp_url;
