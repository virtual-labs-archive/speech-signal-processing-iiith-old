...
def writefile(fname,s,s1,heading):
	...
	content=f.read()
	#print content
	filedata=content.replace('index.html','Objective.html?domain=Computer Science&lab='+heading)
	f.seek(0)
	f.write(filedata)
...
print heading
breadcrumb='<a href="http://vlab.co.in/broad-area-computer-science-and-engineering" class="sidebar-a" >Computer Science & Engineering</a><br/>'
