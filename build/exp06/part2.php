...
function loadwavfile(filename){
	...
	speechtooljs.hidePlaySelection(hideTP);
	speechtooljs.hideTransportPanel(hideTP);
...
if($changeflag == 1){
 ...
 echo "<applet code=spectrographicAnalysis.SpectrographicAnalysisApplet.class archive=media/spectrographicAnalysisS.jar name='speechtool' width=800 height=550>";
