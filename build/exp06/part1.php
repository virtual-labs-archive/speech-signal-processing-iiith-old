...
function loadwavfile(filename){
	...
	speechtooljs.hideSelectionMenu(hide);
}
...
<table width=900><tr>
<td><h2>Part-1: Pre-segmented examples</h2></td>
<td width=200 align=right><a href=part2.php><b>Part-2 &gt;&gt;</b></a></td>
</tr></table>

<font size=-1> <a href=readme.html>README</a></font><br><br>
...
if($changeflag == 1){
 ...
 echo "<font size=-1>";
 echo "<ol>";
 echo "<li>Verify the subword unit boundaries given in the table by zooming and listening to selected portions of the waveform.</li>";
 ...
 echo "<applet code=spectrographicAnalysis.SpectrographicAnalysisApplet.class archive=media/spectrographicAnalysisS.jar name='speechtool' width=700 height=550>";
// echo "<applet code=audioTransport/SVLAudioTool.class archive='speechAnalysis.jar' name='speechtool' width=600 height=400>";
